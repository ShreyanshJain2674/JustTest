        ...
        go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Email.getText().toString().isEmpty()){
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(mail,"123456").addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                Toast.makeText(Main2Activity.this,"Succesfully Created ... Your Email is " + mail +"Password is 123456" ,
